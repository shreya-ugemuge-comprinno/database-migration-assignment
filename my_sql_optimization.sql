...
('ORDER BY current_inventory_stock DESC'),
('-- Before'),
('-> Sort: current_inventory_stock DESC'),
...
('ON production_transactionhistory (transactiondate'),
...
('-- 2. Build the perfect composite B-Tree index to handle the dates'),
('CREATE INDEX idx_soh_date_cc_subtotal'),
('ON sales_salesorderheader (orderdate'),
